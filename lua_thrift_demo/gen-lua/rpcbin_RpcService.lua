...
require 'Thrift'
require 'rpcbin_ttypes'

RpcServiceClient = __TObject.new(__TClient, {
  __type = 'RpcServiceClient'
})

function RpcServiceClient:funCall(argStruct, argByte, argI16, argI32, argI64, argDouble, argString, paramMapStrStr, paramMapI32Str, paramSetStr, paramSetI64, paramListStr)
  self:send_funCall(argStruct, argByte, argI16, argI32, argI64, argDouble, argString, paramMapStrStr, paramMapI32Str, paramSetStr, paramSetI64, paramListStr)
  return self:recv_funCall(argStruct, argByte, argI16, argI32, argI64, argDouble, argString, paramMapStrStr, paramMapI32Str, paramSetStr, paramSetI64, paramListStr)
end

function RpcServiceClient:send_funCall(argStruct, argByte, argI16, argI32, argI64, argDouble, argString, paramMapStrStr, paramMapI32Str, paramSetStr, paramSetI64, paramListStr)
  self._seqid=1
...
function RpcServiceClient:recv_funCall(argStruct, argByte, argI16, argI32, argI64, argDouble, argString, paramMapStrStr, paramMapI32Str, paramSetStr, paramSetI64, paramListStr)
...
function RpcServiceProcessor:process_funCall(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = funCall_result:new{}
  local status, res = pcall(self.handler.funCall, self.handler, args.argStruct, args.argByte, args.argI16, args.argI32, args.argI64, args.argDouble, args.argString, args.paramMapStrStr, args.paramMapI32Str, args.paramSetStr, args.paramSetI64, args.paramListStr)
  if not status then
...
function funCall_args:write(oprot)
  ...
  if self.paramListStr then
    ...
    oprot:writeListBegin(TType.STRING, #self.paramListStr)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size34 do
          local _elem38 = iprot:readString()
